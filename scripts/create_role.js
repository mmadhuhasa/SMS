$(document).ready(function() { 
  ...
  $('#createUserRoleForm').submit(function (e) {
    e.preventDefault();
    //alert($(this).serialize());
    document.getElementById("createUserRoleForm").style.display = 'block';
...
cancelButtonText: 'false'
  ...
  setTimeout(function(){
  window.location.replace(base_url+'manage-user-roles');
  }, 1800);
      }
          },
  ...
  $('#updateUserRoleForm').submit(function (e) {
    e.preventDefault();
    //alert($(this).serialize());
    document.getElementById("updateUserRoleForm").style.display = 'block';
